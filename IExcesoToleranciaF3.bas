Attribute VB_Name = "IExcesoToleranciaF3"
Sub Excesos_Tolerancia_F3()
...
Private Sub Obtengo_Datos()
    ...
    Sheets("Dotacion Ofisis (2)").Name = "Exc_Tol_2"
    Sheets("Exc_Tol_2").Select
    ...
    Range("A:P,S:S,U:V,Z:AV").Columns.Delete
    ...
    Select Case z
        ...
        Case 1
            ...
            Range("L2").FormulaLocal = "Exc. Tol. Refrigerio"
        Case Else
